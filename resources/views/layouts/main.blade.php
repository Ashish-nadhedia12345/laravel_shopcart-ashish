...
<head>
    ...
    <link href="{{ asset('/frontend-theme/lib/animate/animate.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('/frontend-theme/mail/jqBootstrapValidation.min.js') }}"></script>
    <script src="{{ asset('/frontend-theme/mail/contact.js') }}"></script>
